...
def main():
    if len(sys.argv) != 2:
        ...
        return 1
    try:
        output = subprocess.check_output(f'objdump -T {sys.argv[1]} | grep mkl_serv_intel_cpu',shell=True, text=True).rstrip('\n').split('\n')
    ...
    try:
        ...
        print("cannot write to file, do you have write permission to the file?")
